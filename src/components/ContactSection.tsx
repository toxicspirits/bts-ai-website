            ...
            <div className="bg-white p-8 rounded-lg shadow-md h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">169 soi 1 udomsuk 58, mooban rangsiya, บางนา, Bang Na, Bangkok 10260</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  {/*  </svg>*/}
                  {/*</a>*/}
                  <a href="https://www.linkedin.com/company/bts-ai/?viewAsMember=true" className="bg-btsai-purple/10 p-3 rounded-full hover:bg-btsai-purple/20 transition-colors">
                    <svg className="h-5 w-5 text-btsai-purple" fill="currentColor" viewBox="0 0 24 24">
